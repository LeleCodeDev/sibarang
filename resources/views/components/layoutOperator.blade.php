        ...
        <div class="flex items-center gap-3">
          ...
          <div class="dropdown dropdown-end">
            <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
              <div class="">
                <svg class="w-7 h-7" id="theme-icon-dark-user" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <ul tabindex="0" class="menu dropdown-content z-[1] p-2 shadow-lg bg-base-200 rounded-box w-52 mt-4">
              <li>
        ...
        <ul class="p-4 space-y-2">
          @php
            $menus = [
                ...
                [
                    'name' => 'Requests',
                    'route' => 'borrow-request.index',
                    'icon' => '<svg class="w-7 h-7 transition-colors" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
