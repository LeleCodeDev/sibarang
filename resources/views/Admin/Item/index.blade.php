            ...
            <tbody>
              @forelse ($items as $item)
                <tr class="hover">
                  ...
                  <td><img src="{{ asset('storage/' . $item->image) }}" class="rounded max-w-[150px] object-cover"
                      alt=""></td>
                  <td>
                    <span
                      class="badge badge-outline {{ $item->status == 'available' ? 'badge-success' : 'badge-error' }} ">
                      {{ $item->status }}
                    </span>
                  </td>
                  <td class="text-right">
                    <div class="dropdown dropdown-end">
                      ...
                      <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-40">
                        ...
                        <li>
                          <button onclick="delete_modal_{{ $item->id }}.showModal()" type="submit"
