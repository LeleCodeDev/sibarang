            ...
            <tbody>
              @forelse ($recentBorrowings ?? [] as $borrowing)
                ...
                <tr class="hover">
                  ...
                  <td class="p-4">
                    <div
                      class="flex flex-col items-center gap-2 p-2 bg-base-100 rounded-lg border border-base-300 hover:shadow-md transition-shadow ">
                      <div class="avatar flex-shrink-0">
                        <div class="mask mask-squircle w-12 h-12">
                          <img
                            src="{{ $borrowing->item && $borrowing->item->image ? asset('storage/' . $borrowing->item->image) : asset('images/default.png') }}"
                            alt="{{ $borrowing->item->name ?? 'Unknown Item' }}" class="object-cover" />
                        </div>
                      </div>

                      <p class="text-sm font-medium text-center leading-tight break-words whitespace-normal">
                        {{ $borrowing->item->name }}
                      </p>

                      <span class="badge badge-primary badge-sm">{{ $borrowing->quantity }}x
                      </span>
                    </div>
                  </td>
